                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <a class="btn btn-sm btn-success"
                               href="{{ route('company.create') }}">{{ __('Create New Company') }}</a>
                        </div>
